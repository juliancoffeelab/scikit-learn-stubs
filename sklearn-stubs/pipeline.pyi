...
class Pipeline(_BaseComposition):
    ...
    def fit(
        self,
        X: list[str] | ndarray | Iterable[object] | DataFrame,
        y: list[Int] | list[int] | Iterable[object] | None | Series | ndarray = None,
        **fit_params: object,
    ) -> Self: ...
...
class FeatureUnion(TransformerMixin, _BaseComposition):
    ...
    def set_params(self, **kwargs) -> Self: ...
    def get_feature_names_out(self, input_features: None | ArrayLike = None) -> ndarray: ...
    def fit(self, X: Iterable | ArrayLike, y: None | MatrixLike = None, **fit_params) -> Self: ...
    def fit_transform(
