...
@overload
def load_wine(*, return_X_y: Literal[False] = False, as_frame: bool = False) -> Bunch: ...
@overload
def load_wine(*, return_X_y: Literal[True], as_frame: bool = False) -> tuple[ndarray, ndarray]: ...
@overload
def load_wine(*, return_X_y: bool = False, as_frame: bool = False) -> Bunch | tuple[ndarray, ndarray]: ...
